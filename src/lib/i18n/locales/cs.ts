const cs = {
  ...
  wizard: {
    ...
    steps: {
      ...
      models: {
        ...
        downloading: "Stahuji...",
        ready: "staženo",
        skippedNote: "Model přeskočen. Bez staženého modelu appka chat nespustí. Modely lze stáhnout kdykoliv v Nastavení.",
  ...
  settings: {
    ...
    llm: {
      ...
      hint: "Appka běží čistě lokálně. Model se nahraje přímo do procesu a appka si sama spočítá, co poslat na GPU a co nechat v RAM — podle velikosti modelu a volné VRAM.",
      test: "Test připojení",
      connected: "Připojeno",
