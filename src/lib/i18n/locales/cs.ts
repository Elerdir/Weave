  ...
  wizard: {
    ...
    steps: {
      ...
      openvino: {
        ...
        hint: "NPU nepouziva GGUF modely. Pro NPU je potreba OpenVINO IR model; bez toho muzes pokracovat a pouzivat GPU.",
      },
      models: {
        title: "Místní modely",
        ...
        downloading: "Stahuji...",
        ready: "staženo",
        skippedNote: "Model přeskočen. Bez GPU modelu (nebo nastaveného NPU backendu v předchozím kroku) appka chat nespustí. Modely lze stáhnout kdykoliv v Nastavení.",
