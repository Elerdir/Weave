...
const en: Messages = {
  ...
  wizard: {
    ...
    steps: {
      ...
      models: {
        ...
        ready: "downloaded",
        skippedNote: "Model skipped. Without a downloaded model the app cannot chat. You can download models anytime in Settings.",
  ...
  settings: {
    ...
    llm: {
      ...
      hint: "The app runs fully locally. The model loads directly into the process and the app works out what to put on the GPU and what to keep in RAM — based on model size and free VRAM.",
