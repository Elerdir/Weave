  ...
  wizard: {
    ...
    steps: {
      ...
      openvino: {
        ...
        hint: "NPU does not use GGUF models. It needs an OpenVINO IR model; you can skip this and keep using GPU instead.",
      },
      models: {
        title: "Local Models",
        ...
        ready: "downloaded",
        skippedNote: "Model skipped. Without a GPU model (or an NPU backend set up in the previous step), the app won't be able to chat. You can download models anytime in Settings.",
